...
- [ ] Dish type selector pills (5 types)
...
- [ ] Header: "Best [Dish Type] in New Orleans"
- [ ] Toggle: `City` | `Near Me (2mi)` | `[Neighborhood]`
- [ ] Ranked list 1-10
    - Crown emoji for #1
    - Restaurant name + neighborhood
    - Confidence meter
    - Photo thumbnail
- [ ] Tappable rows -> Dish Detail
...
- [ ] "Best Ever" cards (auto-generated per dish type)
    - Photo + restaurant + date
    - Share button
- [ ] Stats row: `X dishes` | `X cities` | `X battles`
- [ ] Badges: "Gumbo Authority" etc.
- [ ] Map view toggle (pins of what you've eaten)
...
- [ ] **BestEverCard** - Personal best dish card with share
