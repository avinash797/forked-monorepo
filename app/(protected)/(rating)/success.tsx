  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedView style={styles.content}>
        ...
        <ThemedText style={styles.message} lightColor="#666" darkColor="#999">
          Thank you for sharing your food experience. Your review will help others discover great dishes.
        </ThemedText>

        <ThemedText style={styles.info} lightColor="#666" darkColor="#999">
          Your review is pending moderation and will be visible soon.
        </ThemedText>

        <ThemedButton
          onPress={handleRateAnother}
          style={styles.button}
        >
          Rate Another Dish
        </ThemedButton>
