...
const venueFormSchema = z.object({
  ...
  address: z.string().min(1, "Address is required - please select from suggestions"),
...
export default function CreateVenueScreen() {
  ...
  const { createVenue, isLoading, error } = useCreateVenue();
  ...
  return (
    <ScrollView style={styles.container}>
      <ThemedView style={styles.content}>
        <ThemedText style={styles.sectionTitle}>Venue Information</ThemedText>
            ...
            render={({ field: { onChange } }) => (
              <AddressAutocomplete
                onSelect={(addressData) => {
                  ...
                  setValue("address_country", addressData.country);
