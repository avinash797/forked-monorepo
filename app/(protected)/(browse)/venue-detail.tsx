...
export default function VenueDetailScreen() {
  ...
  if (isLoading) {
    return (
      <View style={[styles.loadingContainer, { backgroundColor: theme.color.bg }]}>
        ...
        <ThemedText style={styles.loadingText}>Loading venue...</ThemedText>
      </View>
    );
  }
  ...
  const averageRating = dishes.length > 0
    ? dishes.reduce((acc, d) => acc + (d.average_rating || 0), 0) / dishes.length
    : null;
    ...
    <ThemedView style={styles.container}>
      ...
      <Animated.View style={[styles.stickyHeader, { paddingTop: insets.top }, animatedHeaderStyle]}>
        <View style={styles.headerContent}>
          ...
          {averageRating !== null && (
            <ScoreBadge score={averageRating} style={styles.headerBadge} />
          )}
        </View>
      </Animated.View>
      ...
      >
        ...
        <Animated.View style={[styles.heroSection, animatedHeroStyle]}>
          ...
          <View style={styles.heroContent}>
            <ThemedText style={styles.venueNameHero} numberOfLines={2}>
              {venue.name}
            </ThemedText>
            ...
            <View style={styles.metaRowHero}>
              <View style={styles.cuisinesContainer}>
                {venue.cuisine_types?.map((cuisine, index) => (
                  <ThemedText key={index} style={styles.cuisineTextHero}>
                    {index > 0 ? ' • ' : ''}{cuisine}
                  </ThemedText>
                ))}
              </View>
        ...
        <View style={styles.contentSection}>
          <View style={styles.infoBox}>
            <View style={styles.addressRow}>
              <IconSymbol name="location-on" size={20} color={theme.color.textTertiary} />
