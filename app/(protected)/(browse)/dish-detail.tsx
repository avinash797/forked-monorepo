...
export default function DishDetailScreen() {
  ...
  const heroPhoto = allPhotos.length > 0 ? allPhotos[0] : (dish?.photos?.[0] || null);
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <Animated.View style={[styles.stickyHeader, { paddingTop: insets.top }, animatedHeaderStyle]}>
        <View style={styles.headerContent}>
          ...
          {dish.average_rating !== null && (
            <ScoreBadge score={dish.average_rating} style={styles.headerRating} />
          )}
        </View>
      </Animated.View>
      ...
      >
        ...
        <Animated.View style={[styles.heroSection, animatedHeroStyle]}>
          {heroPhoto ? (
            ...
            <View style={[styles.heroImage, { backgroundColor: theme.color.surface }]} />
          )}
          ...
          <Animated.View style={[styles.heroContent, animatedHeroContentStyle]}>
        ...
        <View style={styles.contentSection}>
          ...
          {reviews.length > 0 && (
            <View style={styles.rateButtonContainer}>
              <ThemedButton onPress={handleRateDishPress} style={styles.rateButton}>
                Rate This Dish
              </ThemedButton>
            </View>
          )}
...
const createThemedStyles = (theme: ReturnType<typeof useTheme>['theme'], insets: any) =>
  StyleSheet.create({
    container: {
      flex: 1,
    },
    ...
    tag: {
      ...
      borderWidth: 1,
      borderColor: theme.mode === 'dark' ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.02)',
    },
    tagText: {
