    ...
    <section ref={ref} className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {steps.map((step, i) => (
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-[#FF4D00]/10 flex items-center justify-center mx-auto">
              <step.icon size={28} className="text-[#FF4D00]" />
            </div>
      ...
      <motion.blockquote
        className="border-l-2 border-[#FF4D00]/40 pl-6 py-2 text-white/30 italic text-sm max-w-xl mx-auto"
