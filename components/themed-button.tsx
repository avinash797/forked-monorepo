  ...
  return (
    <Pressable
      style={({ pressed }) => [
        ...
        variant === "primary" ? builtStyles.buttonPrimary : builtStyles.buttonSecondary,
      ]}
      disabled={isDisabled}
      android_ripple={{
    ...
    >
      {loading ? (
        <ActivityIndicator color={variant === "primary" ? theme.color.accentOn : theme.color.textPrimary} />
      ) : typeof children === "string" ? (
        <ThemedText
          style={variant === "primary" ? builtStyles.buttonPrimaryText : builtStyles.buttonSecondaryText}
        >
          {children}
        </ThemedText>
      ) : (
